...
function Tabs() {
  ...
  return (
    <div className="tabs">
      ...
      <button className={getClassName('/announcements')} onClick={() => navigate('/announcements')}>S4 · 공모전 & 해커톤</button>
      ...
      <button className={getClassName('/review')} onClick={() => navigate('/review')}>S8 · 매칭 후기</button>
    </div>
  );
}
